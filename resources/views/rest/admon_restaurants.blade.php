@extends('base')
@section('tittle')
    <title>Food Wishes - Administrar Restaurantes</title>
@endsection
@section('content')
    <div class="row">
        <div class="col">
                            ...
                            @isset($restaurants)
                                @foreach ($restaurants as $restaurant)
                                    <tr>
                                        ...
                                        <td class="text-center"> <a href="{{ route('rest.update', $restaurant) }}" class="btn btn-info">
                                                <i class="fas fa-edit nav-icon"></i>
                                            </a>
                                        </td>
                                        <td class="text-center">
                                            <form action="{{ route('rest.destroy', $restaurant) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
