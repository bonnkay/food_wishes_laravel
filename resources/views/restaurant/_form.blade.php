...
<div class="row">
    <div class="col">
        ...
        <div class="form-group">
            ...
            <br>
            <textarea class="textarea" name="description" id="description" cols="75" rows="5"
                placeholder="Escribe aquí la descripción">{{ old('description', $restaurant) }}</textarea>
            @error('description')
                <div class="text-xs text-red">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col">
            ...
            <div class="d-flex justify-content-center">
                <img id="preview-image-before-upload"
                    src="@isset($restaurant) {{ asset('storage/restaurants/' . $restaurant->image) }} @else {{ asset('img/upload-image.png') }} @endisset"
